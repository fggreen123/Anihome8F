...
{
    /// <summary>Optional, self-contained first-person preview. Click to look; Escape releases the pointer.</summary>
    ...
    public sealed class DormitoryWalkthrough : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            bool capture = false, release = false, sprint = false;
            Vector2 move = Vector2.zero, mouse = Vector2.zero;
#if ENABLE_INPUT_SYSTEM
            ...
            if (keyboard != null)
            {
                ...
                move.x = (keyboard.dKey.isPressed || keyboard.rightArrowKey.isPressed ? 1 : 0)
                       - (keyboard.aKey.isPressed || keyboard.leftArrowKey.isPressed ? 1 : 0);
                move.y = (keyboard.wKey.isPressed || keyboard.upArrowKey.isPressed ? 1 : 0)
